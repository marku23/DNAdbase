...
public class DataProcessor {
     ...
     * @param memory - the memory file
     */
    public DataProcessor (RandomAccessFile hashFile, RandomAccessFile memoryFile)
    {
        hash = hashFile;
        memory = memoryFile;
    }
     ...
     * memory manager
     * @param ID - the ID of the sequence we are removing
     */
     ...
     * ID, if there is one
     * @param ID - the ID of the sequence we are searching for
     */
